...
Each one of the elements have to fulfill a certain criteria.
...
- `cohort_name` it must contain unique cohort names (currently it must be snake case*)
...
- The must exist unique pairs of `cohort_definition_id` and `reason_id`.
