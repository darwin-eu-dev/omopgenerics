...
- There is no overlap between observations. A person must be a cohort several times, but it can't enter the cohort before leaving it. So an individual can't be simulatniuoly more than once in the same cohort.
