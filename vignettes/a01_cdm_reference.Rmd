...
cli::cli_inform(mes)
requiredOmopCdmColumns(table = "person", version = "5.3")
```

Meanwhile the observation period table includes

```{r}
print(requiredOmopCdmColumns(table = "observation_period", version = "5.3"))
```
...
```{r}
# requiredOmopCdmColumns(table = "cohort", version = "5.3")
```
