...
### Participants
A summarised result may, as an optional attribute, contain a reference to the patients that informed the result. The participans will contain a "subject_id" column which can be used to identify individuals in the person table (or other tables in the cdm reference).
