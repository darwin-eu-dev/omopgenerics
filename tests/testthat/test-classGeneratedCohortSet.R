test_that("test create omop_cohort", {
  ...
  expect_error(cohort1 <- generatedCohortSet(x, cohortAttritionTable = cohort_attrition1))
  expect_no_error(cohort2 <- generatedCohortSet(x, cohortAttritionTable = cohort_attrition2))
  expect_no_error(cohort3 <- generatedCohortSet(x, cohortAttritionTable = cohort_attrition3))
  expect_error(cohort4 <- generatedCohortSet(x, cohortAttritionTable = cohort_attrition4))
  expect_error(cohort5 <- generatedCohortSet(x, cohortAttritionTable = cohort_attrition5))
  ...
  class(cohort2) <- class(cohort2)[class(cohort2) != "generated_cohort_set"]
